...
|---|---:|---:|---:|
| LDA | 0.4917 | 0.4917 | 0.4881 |
| SVM | 0.5083 | 0.5083 | 0.5056 |
| Logistic Regression | 0.5125 | 0.5125 | 0.5087 |
| KNN | 0.4875 | 0.4875 | 0.4874 |
| Random Forest | 0.5042 | 0.5042 | 0.5040 |
...
| 模型 | Accuracy | Balanced Accuracy | Macro F1 |
|---|---:|---:|---:|
| LDA | 0.2437 | 0.2437 | 0.2326 |
| SVM | 0.2917 | 0.2917 | 0.2911 |
| Logistic Regression | 0.2542 | 0.2542 | 0.2401 |
| KNN | 0.2562 | 0.2562 | 0.2467 |
| Random Forest | 0.2687 | 0.2688 | 0.2589 |

按 Balanced Accuracy，本次实验表现最佳的模型为 **SVM**（0.2917）。
...
| 模型 | Accuracy | Balanced Accuracy | Macro F1 |
|---|---:|---:|---:|
| LDA | 0.2056 | 0.2056 | 0.1968 |
| SVM | 0.1917 | 0.1917 | 0.1882 |
| Logistic Regression | 0.2111 | 0.2111 | 0.1953 |
| KNN | 0.1944 | 0.1944 | 0.1818 |
| Random Forest | 0.1958 | 0.1958 | 0.1887 |

按 Balanced Accuracy，本次实验表现最佳的模型为 **Logistic Regression**（0.2111）。
