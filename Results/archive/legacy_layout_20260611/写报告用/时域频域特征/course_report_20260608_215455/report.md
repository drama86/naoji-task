...
|---|---:|---:|---:|
| LDA | 0.5417 | 0.5417 | 0.5405 |
| SVM | 0.4708 | 0.4708 | 0.4706 |
| Logistic Regression | 0.5500 | 0.5500 | 0.5492 |
| KNN | 0.5208 | 0.5208 | 0.5184 |
| Random Forest | 0.5708 | 0.5708 | 0.5708 |

按 Balanced Accuracy，本次实验表现最佳的模型为 **Random Forest**（0.5708）。
...
| 模型 | Accuracy | Balanced Accuracy | Macro F1 |
|---|---:|---:|---:|
| LDA | 0.2979 | 0.2979 | 0.2986 |
| SVM | 0.3021 | 0.3021 | 0.3008 |
| Logistic Regression | 0.3146 | 0.3146 | 0.3151 |
| KNN | 0.2708 | 0.2708 | 0.2692 |
| Random Forest | 0.3063 | 0.3062 | 0.3035 |

按 Balanced Accuracy，本次实验表现最佳的模型为 **Logistic Regression**（0.3146）。
...
| 模型 | Accuracy | Balanced Accuracy | Macro F1 |
|---|---:|---:|---:|
| LDA | 0.2347 | 0.2347 | 0.2349 |
| SVM | 0.2083 | 0.2083 | 0.2089 |
| Logistic Regression | 0.2333 | 0.2333 | 0.2335 |
| KNN | 0.2097 | 0.2097 | 0.2099 |
| Random Forest | 0.2569 | 0.2569 | 0.2543 |

按 Balanced Accuracy，本次实验表现最佳的模型为 **Random Forest**（0.2569）。
