...
|---|---:|---:|---:|
| LDA | 0.5792 | 0.5792 | 0.5788 |
| SVM | 0.5542 | 0.5542 | 0.5535 |
| Logistic Regression | 0.5583 | 0.5583 | 0.5578 |
| KNN | 0.5208 | 0.5208 | 0.5164 |
| Random Forest | 0.5667 | 0.5667 | 0.5665 |

按 Balanced Accuracy，本次实验表现最佳的模型为 **LDA**（0.5792）。
...
| 模型 | Accuracy | Balanced Accuracy | Macro F1 |
|---|---:|---:|---:|
| LDA | 0.3521 | 0.3521 | 0.3522 |
| SVM | 0.3354 | 0.3354 | 0.3353 |
| Logistic Regression | 0.3646 | 0.3646 | 0.3650 |
| KNN | 0.3187 | 0.3187 | 0.3184 |
| Random Forest | 0.3646 | 0.3646 | 0.3645 |

按 Balanced Accuracy，本次实验表现最佳的模型为 **Logistic Regression**（0.3646）。
...
| 模型 | Accuracy | Balanced Accuracy | Macro F1 |
|---|---:|---:|---:|
| LDA | 0.2806 | 0.2806 | 0.2813 |
| SVM | 0.2708 | 0.2708 | 0.2695 |
| Logistic Regression | 0.2625 | 0.2625 | 0.2624 |
| KNN | 0.2389 | 0.2389 | 0.2389 |
| Random Forest | 0.2764 | 0.2764 | 0.2761 |

按 Balanced Accuracy，本次实验表现最佳的模型为 **LDA**（0.2806）。
