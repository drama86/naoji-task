...
| Logistic Regression | 0.2500 | 0.2500 | 0.2360 |
| KNN | 0.2396 | 0.2396 | 0.2296 |
...
| Logistic Regression | 0.2125 | 0.2125 | 0.1965 |
| KNN | 0.1861 | 0.1861 | 0.1717 |
| Random Forest | 0.1958 | 0.1958 | 0.1887 |

按 Balanced Accuracy，本次实验表现最佳的模型为 **Logistic Regression**（0.2125）。
