...
|---|---:|---:|---:|
| LDA | 0.5167 | 0.5167 | 0.5090 |
| SVM | 0.5417 | 0.5417 | 0.5257 |
| Logistic Regression | 0.5208 | 0.5208 | 0.5127 |
| KNN | 0.5250 | 0.5250 | 0.5128 |
| Random Forest | 0.5625 | 0.5625 | 0.5623 |

按 Balanced Accuracy，本次实验表现最佳的模型为 **Random Forest**（0.5625）。
...
| 模型 | Accuracy | Balanced Accuracy | Macro F1 |
|---|---:|---:|---:|
| LDA | 0.2729 | 0.2729 | 0.2709 |
| SVM | 0.2875 | 0.2875 | 0.2731 |
| Logistic Regression | 0.2521 | 0.2521 | 0.2484 |
| KNN | 0.2875 | 0.2875 | 0.2842 |
| Random Forest | 0.2375 | 0.2375 | 0.2355 |
...
| 模型 | Accuracy | Balanced Accuracy | Macro F1 |
|---|---:|---:|---:|
| LDA | 0.1972 | 0.1972 | 0.1960 |
| SVM | 0.1944 | 0.1944 | 0.1920 |
| Logistic Regression | 0.1806 | 0.1806 | 0.1801 |
| KNN | 0.1667 | 0.1667 | 0.1656 |
| Random Forest | 0.1819 | 0.1819 | 0.1754 |
