...
|---|---:|---:|---:|
| LDA | 0.5083 | 0.5083 | 0.5075 |
| SVM | 0.5167 | 0.5167 | 0.5100 |
| Logistic Regression | 0.5208 | 0.5208 | 0.5208 |
| KNN | 0.4917 | 0.4917 | 0.4847 |
| Random Forest | 0.4417 | 0.4417 | 0.4316 |

按 Balanced Accuracy，本次实验表现最佳的模型为 **Logistic Regression**（0.5208）。
...
| 模型 | Accuracy | Balanced Accuracy | Macro F1 |
|---|---:|---:|---:|
| LDA | 0.2958 | 0.2958 | 0.2887 |
| SVM | 0.2521 | 0.2521 | 0.2437 |
| Logistic Regression | 0.2938 | 0.2938 | 0.2890 |
| KNN | 0.2479 | 0.2479 | 0.2441 |
| Random Forest | 0.2521 | 0.2521 | 0.2480 |

按 Balanced Accuracy，本次实验表现最佳的模型为 **LDA**（0.2958）。
...
| 模型 | Accuracy | Balanced Accuracy | Macro F1 |
|---|---:|---:|---:|
| LDA | 0.2056 | 0.2056 | 0.2009 |
| SVM | 0.1792 | 0.1792 | 0.1677 |
| Logistic Regression | 0.1681 | 0.1681 | 0.1659 |
| KNN | 0.1583 | 0.1583 | 0.1567 |
| Random Forest | 0.1736 | 0.1736 | 0.1720 |

按 Balanced Accuracy，本次实验表现最佳的模型为 **LDA**（0.2056）。
