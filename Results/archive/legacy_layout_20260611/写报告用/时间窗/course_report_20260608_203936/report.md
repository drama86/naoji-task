...
|---|---:|---:|---:|
| LDA | 0.5000 | 0.5000 | 0.4941 |
| SVM | 0.4958 | 0.4958 | 0.4903 |
| Logistic Regression | 0.5000 | 0.5000 | 0.4941 |
| KNN | 0.4917 | 0.4917 | 0.4865 |
| Random Forest | 0.4583 | 0.4583 | 0.4545 |

按 Balanced Accuracy，本次实验表现最佳的模型为 **LDA**（0.5000）。
...
| 模型 | Accuracy | Balanced Accuracy | Macro F1 |
|---|---:|---:|---:|
| LDA | 0.2500 | 0.2500 | 0.2434 |
| SVM | 0.2479 | 0.2479 | 0.2430 |
| Logistic Regression | 0.2396 | 0.2396 | 0.2362 |
| KNN | 0.2687 | 0.2687 | 0.2651 |
| Random Forest | 0.2271 | 0.2271 | 0.2243 |

按 Balanced Accuracy，本次实验表现最佳的模型为 **KNN**（0.2687）。
...
| 模型 | Accuracy | Balanced Accuracy | Macro F1 |
|---|---:|---:|---:|
| LDA | 0.2014 | 0.2014 | 0.1949 |
| SVM | 0.1986 | 0.1986 | 0.1958 |
| Logistic Regression | 0.1875 | 0.1875 | 0.1829 |
| KNN | 0.1931 | 0.1931 | 0.1925 |
| Random Forest | 0.1889 | 0.1889 | 0.1848 |

按 Balanced Accuracy，本次实验表现最佳的模型为 **LDA**（0.2014）。
