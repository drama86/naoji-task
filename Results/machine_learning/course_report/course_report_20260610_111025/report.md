...
|---|---:|---:|---:|
| LDA | 0.6208 | 0.6208 | 0.6207 |
| SVM | 0.5917 | 0.5917 | 0.5917 |
| Logistic Regression | 0.6125 | 0.6125 | 0.6122 |
| KNN | 0.5417 | 0.5417 | 0.5401 |
| Random Forest | 0.6083 | 0.6083 | 0.6083 |

按 Balanced Accuracy，本次实验表现最佳的模型为 **LDA**（0.6208）。
...
| 模型 | Accuracy | Balanced Accuracy | Macro F1 |
|---|---:|---:|---:|
| LDA | 0.3396 | 0.3396 | 0.3385 |
| SVM | 0.3250 | 0.3250 | 0.3252 |
| Logistic Regression | 0.3396 | 0.3396 | 0.3402 |
| KNN | 0.3125 | 0.3125 | 0.3116 |
| Random Forest | 0.3021 | 0.3021 | 0.3015 |

按 Balanced Accuracy，本次实验表现最佳的模型为 **LDA**（0.3396）。
...
| 模型 | Accuracy | Balanced Accuracy | Macro F1 |
|---|---:|---:|---:|
| LDA | 0.2542 | 0.2542 | 0.2532 |
| SVM | 0.2583 | 0.2583 | 0.2593 |
| Logistic Regression | 0.2542 | 0.2542 | 0.2541 |
| KNN | 0.2250 | 0.2250 | 0.2248 |
| Random Forest | 0.2264 | 0.2264 | 0.2267 |

按 Balanced Accuracy，本次实验表现最佳的模型为 **SVM**（0.2583）。
