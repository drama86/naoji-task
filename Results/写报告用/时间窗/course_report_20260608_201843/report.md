...
|---|---:|---:|---:|
| LDA | 0.5167 | 0.5167 | 0.5118 |
| SVM | 0.5208 | 0.5208 | 0.5116 |
| Logistic Regression | 0.5167 | 0.5167 | 0.5155 |
| KNN | 0.4875 | 0.4875 | 0.4569 |
| Random Forest | 0.5458 | 0.5458 | 0.5400 |
...
| 模型 | Accuracy | Balanced Accuracy | Macro F1 |
|---|---:|---:|---:|
| LDA | 0.2667 | 0.2667 | 0.2643 |
| SVM | 0.2708 | 0.2708 | 0.2701 |
| Logistic Regression | 0.2896 | 0.2896 | 0.2812 |
| KNN | 0.2542 | 0.2542 | 0.2485 |
| Random Forest | 0.2583 | 0.2583 | 0.2523 |

按 Balanced Accuracy，本次实验表现最佳的模型为 **Logistic Regression**（0.2896）。
...
| 模型 | Accuracy | Balanced Accuracy | Macro F1 |
|---|---:|---:|---:|
| LDA | 0.1972 | 0.1972 | 0.1954 |
| SVM | 0.1889 | 0.1889 | 0.1845 |
| Logistic Regression | 0.1972 | 0.1972 | 0.1969 |
| KNN | 0.1722 | 0.1722 | 0.1697 |
| Random Forest | 0.1917 | 0.1917 | 0.1897 |

按 Balanced Accuracy，本次实验表现最佳的模型为 **LDA**（0.1972）。
