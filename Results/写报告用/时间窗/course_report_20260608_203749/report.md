...
|---|---:|---:|---:|
| LDA | 0.5083 | 0.5083 | 0.4943 |
| SVM | 0.5125 | 0.5125 | 0.4993 |
| Logistic Regression | 0.4958 | 0.4958 | 0.4836 |
| KNN | 0.4708 | 0.4708 | 0.4688 |
| Random Forest | 0.4917 | 0.4917 | 0.4894 |

按 Balanced Accuracy，本次实验表现最佳的模型为 **SVM**（0.5125）。
...
| 模型 | Accuracy | Balanced Accuracy | Macro F1 |
|---|---:|---:|---:|
| LDA | 0.2562 | 0.2562 | 0.2517 |
| SVM | 0.2500 | 0.2500 | 0.2366 |
| Logistic Regression | 0.2437 | 0.2437 | 0.2334 |
| KNN | 0.2500 | 0.2500 | 0.2491 |
| Random Forest | 0.2792 | 0.2792 | 0.2684 |

按 Balanced Accuracy，本次实验表现最佳的模型为 **Random Forest**（0.2792）。
...
| 模型 | Accuracy | Balanced Accuracy | Macro F1 |
|---|---:|---:|---:|
| LDA | 0.1958 | 0.1958 | 0.1947 |
| SVM | 0.1611 | 0.1611 | 0.1569 |
| Logistic Regression | 0.2056 | 0.2056 | 0.2016 |
| KNN | 0.1764 | 0.1764 | 0.1737 |
| Random Forest | 0.1792 | 0.1792 | 0.1755 |

按 Balanced Accuracy，本次实验表现最佳的模型为 **Logistic Regression**（0.2056）。
