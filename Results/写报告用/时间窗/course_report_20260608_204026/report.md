...
|---|---:|---:|---:|
| LDA | 0.4750 | 0.4750 | 0.4550 |
| SVM | 0.5125 | 0.5125 | 0.5118 |
| Logistic Regression | 0.5125 | 0.5125 | 0.5006 |
| KNN | 0.5000 | 0.5000 | 0.4999 |
| Random Forest | 0.5333 | 0.5333 | 0.5286 |

按 Balanced Accuracy，本次实验表现最佳的模型为 **Random Forest**（0.5333）。
...
| 模型 | Accuracy | Balanced Accuracy | Macro F1 |
|---|---:|---:|---:|
| LDA | 0.2604 | 0.2604 | 0.2536 |
| SVM | 0.2625 | 0.2625 | 0.2571 |
| Logistic Regression | 0.2729 | 0.2729 | 0.2678 |
| KNN | 0.2667 | 0.2667 | 0.2642 |
| Random Forest | 0.2479 | 0.2479 | 0.2403 |

按 Balanced Accuracy，本次实验表现最佳的模型为 **Logistic Regression**（0.2729）。
...
| 模型 | Accuracy | Balanced Accuracy | Macro F1 |
|---|---:|---:|---:|
| LDA | 0.1931 | 0.1931 | 0.1834 |
| SVM | 0.1903 | 0.1903 | 0.1876 |
| Logistic Regression | 0.1903 | 0.1903 | 0.1781 |
| KNN | 0.2000 | 0.2000 | 0.2008 |
| Random Forest | 0.1806 | 0.1806 | 0.1737 |

按 Balanced Accuracy，本次实验表现最佳的模型为 **KNN**（0.2000）。
