...
| Logistic Regression | 0.5708 | 0.5708 | 0.5702 |
| KNN | 0.5542 | 0.5542 | 0.5485 |
| Random Forest | 0.5583 | 0.5583 | 0.5581 |

按 Balanced Accuracy，本次实验表现最佳的模型为 **Logistic Regression**（0.5708）。
...
| Logistic Regression | 0.3271 | 0.3271 | 0.3273 |
| KNN | 0.3312 | 0.3312 | 0.3265 |
| Random Forest | 0.3292 | 0.3292 | 0.3272 |

按 Balanced Accuracy，本次实验表现最佳的模型为 **KNN**（0.3312）。
...
| Logistic Regression | 0.2500 | 0.2500 | 0.2504 |
| KNN | 0.2347 | 0.2347 | 0.2341 |
| Random Forest | 0.2625 | 0.2625 | 0.2616 |
